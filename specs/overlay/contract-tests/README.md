# Schemathesis Contract Tests — Overlay HTTP

Property-based contract tests for `specs/overlay/overlay-http.yaml`, powered by [Schemathesis](https://schemathesis.readthedocs.io/).
...
- Reads `../../overlay-http.yaml` (relative to this directory)
