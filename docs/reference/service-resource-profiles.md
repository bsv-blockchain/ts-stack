...
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Chaintracks                   | `CHAINTRACKS_HEADERS_DEFAULT_LIMIT=1000`, `CHAINTRACKS_HEADERS_MAX_LIMIT=1000`, `CHAINTRACKS_HISTORICAL_RATE_LIMIT_MAX=600` per 60 seconds, and `CHAINTRACKS_UPSTREAM_DOWNLOAD_MAX_BYTES_PER_HOUR=536870912`; the static CDN streams files and has its own `CHAINTRACKS_CDN_*` connection policy. The built-in rate and download budgets are process-local.                                                                                                                                                                                                                                                                                                               |
