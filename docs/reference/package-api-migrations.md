...
| `@bsv/wallet-toolbox`             | `2.4.4`      | `2.5.0`  | minor     | [API and usage](../packages/wallet/wallet-toolbox.md)                 | List/find RPC calls that omit a limit now receive the profile default (1,000 in standard), and larger caller limits are rejected above the operator maximum. Existing calls and storage data remain compatible; migrations add auth_sessions and payment_replays automatically.                                               |
| `@bsv/wallet-toolbox-client`      | `2.4.4`      | `2.5.0`  | minor     | [API and usage](../packages/wallet/wallet-toolbox-client.md)          | No browser consumer migration is required; remote storage callers may provide explicit list limits when they need a value other than the operator profile default.                                                                                                                                                            |
| `@bsv/wallet-toolbox-mobile`      | `2.4.4`      | `2.5.0`  | minor     | [API and usage](../packages/wallet/wallet-toolbox-mobile.md)          | No mobile consumer migration is required; remote storage callers may provide explicit list limits when they need a value other than the operator profile default.                                                                                                                                                             |
...
- Release note: Adds resource-profile-aware Wallet Storage RPC pagination, array and response budgets, bounded authenticated response capture, durable payment replay support, double-slash compatibility, and shared auth/payment schema migrations.
- Migration: List/find RPC calls that omit a limit now receive the profile default (1,000 in standard), and larger caller limits are rejected above the operator maximum. Existing calls and storage data remain compatible; migrations add auth_sessions and payment_replays automatically.
...
- Release note: Carries the lockstep Wallet Toolbox build and declarations for the bounded remote-storage contract and shared schema version.
- Migration: No browser consumer migration is required; remote storage callers may provide explicit list limits when they need a value other than the operator profile default.
...
- Release note: Carries the lockstep Wallet Toolbox mobile build and declarations for the bounded remote-storage contract and shared schema version.
- Migration: No mobile consumer migration is required; remote storage callers may provide explicit list limits when they need a value other than the operator profile default.
