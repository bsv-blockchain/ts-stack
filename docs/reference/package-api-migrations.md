...
| `@bsv/wallet-toolbox`             | `2.7.0`      | `2.8.0`  | minor     | [API and usage](../packages/wallet/wallet-toolbox.md)                 | No API migration is required. Existing factories, positional arguments, remote clients, and valid-header behavior remain compatible; headers that do not satisfy their declared proof-of-work target are now rejected. Applications may opt into BulkFileDataCacheApi for packaged or persistent checkpoints, LocalChainTracker for explicit local-primary, remote-only, consistency, clearing, and recovery controls, and WalletServicesOptions.chainTracker to install the composed verifier directly. |
| `@bsv/wallet-toolbox-client`      | `2.7.0`      | `2.8.0`  | minor     | [API and usage](../packages/wallet/wallet-toolbox-client.md)          | No consumer migration is required. Existing browser exports, defaults, and wire contracts remain compatible; applications opt into the new local persistence and management APIs.                                                                                                                                                                                                                                                                                                                        |
| `@bsv/wallet-toolbox-mobile`      | `2.7.0`      | `2.8.0`  | minor     | [API and usage](../packages/wallet/wallet-toolbox-mobile.md)          | No consumer migration is required. Existing React Native exports, remote-storage behavior, and wire contracts remain compatible; applications provide their platform cache or local-storage adapter to opt in.                                                                                                                                                                                                                                                                                           |
...
- Release note: Adds local-first ChainTracks management, a direct composed ChainTracker service seam, proof-of-work enforcement for bulk and live ingestion, typed persistent bulk-header caches, concurrent-miss coalescing, bounded fetch deadlines and bodies, download budgets, and cache/download observability while retaining the pending-transaction reconciliation corrections.
...
- Release note: Carries the browser-safe local-first ChainTracks controller, local proof-of-work enforcement, checkpoint cache contract, download budget, bounded fetch behavior, and lockstep Wallet Toolbox corrections.
- Migration: No consumer migration is required. Existing browser exports, defaults, and wire contracts remain compatible; applications opt into the new local persistence and management APIs.
...
- Release note: Carries the mobile-safe local-first ChainTracks controller, local proof-of-work enforcement, checkpoint cache contract, download budget, bounded fetch behavior, and lockstep Wallet Toolbox corrections.
- Migration: No consumer migration is required. Existing React Native exports, remote-storage behavior, and wire contracts remain compatible; applications provide their platform cache or local-storage adapter to opt in.
