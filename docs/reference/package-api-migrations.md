...
| `@bsv/sdk`                        | `2.2.0`      | `2.2.15` | patch     | [API and usage](../packages/sdk/bsv-sdk.md)                           | No consumer migration is required; the source candidate preserves the 2.x public API, wire encodings, script semantics, errors, and supported import forms.                                                                              |
...
- Release note: Adopts the governed strict TypeScript profile and repository-wide zero-warning lint and formatting contract.
- Migration: No consumer migration is required; client APIs, authenticated socket behavior, and supported imports are unchanged.
