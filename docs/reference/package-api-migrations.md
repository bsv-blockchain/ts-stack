...
- Release note: Adds strict package and edge-policy contracts, restores declaration-safe exports, and adds idempotent HTTP, synchronization, and database shutdown.
...
- Release note: Hardens registry, discovery, and supply-chain validation and reduces topic and lookup production complexity.
...
- Release note: Adds strict browser and server package contracts and hardens wallet construction, output handling, and error behavior.
...
- Release note: Adds the strict package and artifact contract and strengthens relay runtime and declaration consistency.
- Migration: No consumer migration is required; relay protocol and CLI entry points are unchanged.
