...
| `@bsv/wallet-toolbox`             | `2.6.5`      | `2.7.0` | minor     | [API and usage](../packages/wallet/wallet-toolbox.md)                 | Mainnet, testnet, STN, TSTN, and mock defaults are unchanged. TTN now uses https://arcade-v2-ttn-us-1.bsvblockchain.tech unless callers pass an explicit Arcade URL or an empty string to disable it.                                                                                                                         |
| `@bsv/wallet-toolbox-client`      | `2.6.5`      | `2.7.0` | minor     | [API and usage](../packages/wallet/wallet-toolbox-client.md)          | Existing browser consumers are unchanged. Browser wallets configured for chain ttn receive the TTN resolver and Arcade defaults automatically.                                                                                                                                                                                |
| `@bsv/wallet-toolbox-mobile`      | `2.6.5`      | `2.7.0` | minor     | [API and usage](../packages/wallet/wallet-toolbox-mobile.md)          | Existing mobile consumers are unchanged. Mobile wallets configured for chain ttn receive the TTN resolver and Arcade defaults automatically.                                                                                                                                                                                  |
...
- Release note: Routes TTN wallet overlay operations through the isolated teratestnet preset and enables the public TTN Arcade broadcaster and proof provider by default.
- Migration: Mainnet, testnet, STN, TSTN, and mock defaults are unchanged. TTN now uses https://arcade-v2-ttn-us-1.bsvblockchain.tech unless callers pass an explicit Arcade URL or an empty string to disable it.
...
- Release note: Carries the lockstep browser build with isolated TTN overlay routing and the default public TTN Arcade provider.
- Migration: Existing browser consumers are unchanged. Browser wallets configured for chain ttn receive the TTN resolver and Arcade defaults automatically.
...
- Release note: Carries the lockstep mobile build with isolated TTN overlay routing and the default public TTN Arcade provider.
- Migration: Existing mobile consumers are unchanged. Mobile wallets configured for chain ttn receive the TTN resolver and Arcade defaults automatically.
