...
| `@bsv/wallet-toolbox-client`      | `2.9.0`      | `2.10.0` | minor     | [API and usage](../packages/wallet/wallet-toolbox-client.md)          | Existing browser exports, defaults, authentication calls, and wire contracts remain compatible. A settings UI may call startPhoneNumberChange and completePhoneNumberChange, including with the currently registered number, and must save the returned manager snapshot after success. Deploy WAB with the staged commit/finalize protocol and compatible UMP overlay services first.                                                                                                                                                                                                                                                                                                                    |
| `@bsv/wallet-toolbox-mobile`      | `2.9.0`      | `2.10.0` | minor     | [API and usage](../packages/wallet/wallet-toolbox-mobile.md)          | Existing React Native exports, remote-storage behavior, authentication calls, and wire contracts remain compatible. A settings UI may call startPhoneNumberChange and completePhoneNumberChange, including with the currently registered number, and must persist saveSnapshot after success. Deploy WAB with the staged commit/finalize protocol and compatible UMP overlay services first.                                                                                                                                                                                                                                                                                                              |
...
- Release note: Adds WAB-administered UMP ambiguity pinning, interruption-safe same-or-new phone-number changes that stage the WAB key before spending the current UMP token and finalize afterward, restart recovery across current and pending keys, and inputBEEF pruning to declared-input proof dependencies, alongside the local-first ChainTracks management, proof-of-work enforcement, bounded validation, cache, and observability candidate.
...
- Release note: Carries the browser-safe WAB UMP-pin fallback, interruption-safe staged phone-number/presentation-key rotation APIs with verified-login recovery, and inputBEEF pruning to declared-input dependencies together with the local-first ChainTracks controller, proof-of-work enforcement, bounded fetch and inline validation, checkpoint cache, download-budget contracts, and lockstep Wallet Toolbox corrections.
- Migration: Existing browser exports, defaults, authentication calls, and wire contracts remain compatible. A settings UI may call startPhoneNumberChange and completePhoneNumberChange, including with the currently registered number, and must save the returned manager snapshot after success. Deploy WAB with the staged commit/finalize protocol and compatible UMP overlay services first.
...
- Release note: Carries the mobile-safe WAB UMP-pin fallback, interruption-safe staged phone-number/presentation-key rotation APIs with verified-login recovery, and inputBEEF pruning to declared-input dependencies together with the local-first ChainTracks controller, proof-of-work enforcement, bounded fetch and inline validation, checkpoint cache, download-budget contracts, and lockstep Wallet Toolbox corrections.
