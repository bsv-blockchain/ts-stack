...
| `@bsv/wallet-toolbox`             | `2.6.5`      | `2.7.0` | minor     | [API and usage](../packages/wallet/wallet-toolbox.md)                 | Mainnet, testnet, STN, TSTN, and mock service defaults remain compatible; TTN receives its isolated resolver and Arcade default. No consumer code or BRC-100 migration is required for liquidity changes. Exact untouched default baskets at 144 outputs / 32 satoshis advance to a 5,000-satoshi preference; custom values remain authoritative and funds migrate only through future authorized actions. Same-tier compatibility planning and retained pending fallback add no new funding refusal. Operators may tune every work limit, including explicit -1 unlimited modes. |
| `@bsv/wallet-toolbox-client`      | `2.6.5`      | `2.7.0` | minor     | [API and usage](../packages/wallet/wallet-toolbox-client.md)          | No browser consumer code migration is required. TTN wallets receive the isolated resolver and Arcade defaults. Exact untouched IndexedDB defaults advance from 32 to 5,000 satoshis and migrate progressively through ordinary authorized actions; custom basket values and remote-storage wire contracts remain unchanged.                                                                                                                                                                                                                                                       |
| `@bsv/wallet-toolbox-mobile`      | `2.6.5`      | `2.7.0` | minor     | [API and usage](../packages/wallet/wallet-toolbox-mobile.md)          | No mobile consumer code migration is required. TTN wallets receive the isolated resolver and Arcade defaults. Wallets progressively adopt useful change values through future authorized actions; custom basket values, BRC-100 methods, and remote-storage wire contracts remain unchanged.                                                                                                                                                                                                                                                                                      |
...
- Release note: Adds isolated TTN overlay routing and default Arcade support, isolates and resumes action batches, and introduces progressive managed-change liquidity: useful 5,000-satoshi units, bounded surplus-only fanout and fragment migration (including explicitly funded actions), settled-first and measured-BEEF planning, last-resort pending funding, sync-visible SQL metadata, delayed permission persistence, and read-only Monitor reporting.
- Migration: Mainnet, testnet, STN, TSTN, and mock service defaults remain compatible; TTN receives its isolated resolver and Arcade default. No consumer code or BRC-100 migration is required for liquidity changes. Exact untouched default baskets at 144 outputs / 32 satoshis advance to a 5,000-satoshi preference; custom values remain authoritative and funds migrate only through future authorized actions. Same-tier compatibility planning and retained pending fallback add no new funding refusal. Operators may tune every work limit, including explicit -1 unlimited modes.
...
- Release note: Carries the lockstep browser build with isolated TTN routing, default TTN Arcade support, isolated resumable action batches, progressive IndexedDB managed-change liquidity, settled-first ancestry, exact BEEF-cost comparison, and delayed permission persistence.
- Migration: No browser consumer code migration is required. TTN wallets receive the isolated resolver and Arcade defaults. Exact untouched IndexedDB defaults advance from 32 to 5,000 satoshis and migrate progressively through ordinary authorized actions; custom basket values and remote-storage wire contracts remain unchanged.
...
- Release note: Carries the lockstep mobile build with isolated TTN routing, default TTN Arcade support, isolated resumable action batches, progressive managed-change liquidity, settled-first ancestry, exact BEEF-cost comparison, and delayed permission persistence.
- Migration: No mobile consumer code migration is required. TTN wallets receive the isolated resolver and Arcade defaults. Wallets progressively adopt useful change values through future authorized actions; custom basket values, BRC-100 methods, and remote-storage wire contracts remain unchanged.
