...
| `@bsv/wallet-toolbox`             | `2.8.0`      | `2.8.1`  | patch     | [API and usage](../packages/wallet/wallet-toolbox.md)                 | No consumer migration is required. Remote APIs, request defaults, authentication, and wire behavior are unchanged; uniformly upgraded deployments may continue to opt into binaryRequests, while mixed-version endpoints retain the legacy-safe default.                                                                                                                                                                              |
| `@bsv/wallet-toolbox-client`      | `2.8.0`      | `2.8.1`  | patch     | [API and usage](../packages/wallet/wallet-toolbox-client.md)          | No consumer migration is required. Browser exports, defaults, authentication, and wire contracts remain unchanged; binary requests remain an explicit opt-in for uniformly upgraded endpoints.                                                                                                                                                                                                                                        |
| `@bsv/wallet-toolbox-mobile`      | `2.8.0`      | `2.8.1`  | patch     | [API and usage](../packages/wallet/wallet-toolbox-mobile.md)          | No consumer migration is required. React Native exports, defaults, authentication, and wire contracts remain unchanged; binary requests remain an explicit opt-in for uniformly upgraded endpoints.                                                                                                                                                                                                                                   |
...
- Release note: Coalesces concurrent remote availability checks and adds method, phase-specific encoding, and serialized-byte attributes to local remote-storage transport spans so createAction latency and binary-request adoption can be measured without payload data or wire headers.
- Migration: No consumer migration is required. Remote APIs, request defaults, authentication, and wire behavior are unchanged; uniformly upgraded deployments may continue to opt into binaryRequests, while mixed-version endpoints retain the legacy-safe default.
...
- Release note: Carries coalesced remote availability checks and privacy-bounded method, encoding, and serialized-byte transport telemetry for browser and desktop wallet consumers.
- Migration: No consumer migration is required. Browser exports, defaults, authentication, and wire contracts remain unchanged; binary requests remain an explicit opt-in for uniformly upgraded endpoints.
...
- Release note: Carries coalesced remote availability checks and privacy-bounded method, encoding, and serialized-byte transport telemetry for React Native wallet consumers.
- Migration: No consumer migration is required. React Native exports, defaults, authentication, and wire contracts remain unchanged; binary requests remain an explicit opt-in for uniformly upgraded endpoints.
