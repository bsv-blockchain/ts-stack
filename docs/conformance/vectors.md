...
[Generated Stack Facts](../reference/stack-facts.md). The detailed,
...
1. Read `conformance/META.json` and `conformance/PARITY_MATRIX.json` to confirm
   corpus totals and file-level parity status.
