...
| [@bsv/wallet-helper](bsv-wallet-helper.md) | Fluent transaction builder with BRC-29 derivation and ordinal support |
| [@bsv/templates](ts-templates.md) | Low-level script templates (OpReturn, MultiPushDrop, P2MSKH) with lock/unlock patterns |
