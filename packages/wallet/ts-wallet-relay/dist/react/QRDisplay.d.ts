...
import { type QRPairingCodeProps } from './QRPairingCode.js';
 ...
 * ```
 */
export declare function QRDisplay({ session, onRefresh, loadingProps, statusProps, refreshButtonProps, qrProps, children, ...rootProps }: QRDisplayProps): import("react/jsx-runtime").JSX.Element;
