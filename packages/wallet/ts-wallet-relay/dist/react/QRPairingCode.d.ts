 ...
 * ```
 */
export declare function QRPairingCode({ qrDataUrl, pairingUri, onPress, imageProps, children, ...divProps }: QRPairingCodeProps): import("react/jsx-runtime").JSX.Element;
//# sourceMappingURL=QRPairingCode.d.ts.map