 ...
 */
export function buildTransactionNewRow (
  req: TableProvenTxReq,
  proven: TableProvenTx | undefined,
  now: Date = new Date()
): Omit<TableTransactionNew, 'transactionId'> {
 ...
 */
export function buildTransactionNewRowFromLegacyTx (
  tx: TableTransaction,
  now: Date = new Date()
): Omit<TableTransactionNew, 'transactionId'> | undefined {
