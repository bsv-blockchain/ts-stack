# BASELINE — @bsv/project (ump-services)
...
|-------|-------|
| Package | `@bsv/project` |
| Path | `packages/overlays/ump-services` |
| npm | private — not published |
| Version | 1.0.0 |
| Criticality | **Tier 3** — non-critical private UMP (Unified Merchant Protocol) overlay service |
