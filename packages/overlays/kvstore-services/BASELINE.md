# BASELINE — @bsv/kvstore-overlay-services
...
| Field | Value |
|-------|-------|
| Package | `@bsv/kvstore-overlay-services` |
| Path | `packages/overlays/kvstore-services` |
| npm | private — not published |
| Version | 1.0.0 |
| Criticality | **Tier 3** — non-critical private KV-store overlay service |
