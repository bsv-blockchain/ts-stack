# BASELINE — @bsv/apps-overlay-services
...
| Field | Value |
|-------|-------|
| Package | `@bsv/apps-overlay-services` |
| Path | `packages/overlays/apps-overlay-services` |
| npm | private — not published |
| Version | 1.0.0 |
| Criticality | **Tier 3** — non-critical private apps overlay service |
