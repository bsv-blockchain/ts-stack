# BASELINE — @bsv/identity-services (registry-services)
...
| Path | `packages/overlays/registry-services` |
| npm | private — not published |
| Version | 1.0.0 |
| Criticality | **Tier 3** — non-critical private registry overlay service |
...
- Package name `@bsv/identity-services` conflicts with `packages/overlays/identity-services` — naming collision tracked.
