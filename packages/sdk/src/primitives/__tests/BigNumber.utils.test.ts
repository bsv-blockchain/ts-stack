...
describe('BN.js/Utils', () => {
  describe('.toString()', () => {
    describe('hex no padding', () => {
      it('should have same length as input', () => {
        ...
        for (let i = 1; i <= 128; i++) {
          ...
          expect(n.toString(16)).toHaveLength(i)
          hex = hex + '0'
        }
      })
    })
    describe('binary padding', () => {
      it('should have a length of 256', () => {
        ...
        expect(a.toString(2, 256)).toHaveLength(256)
      })
    })
    describe('hex padding', () => {
      it('should have length of 8 from leading 15', () => {
        ...
        expect(a.toString('hex', 2)).toHaveLength(8)
      })

      it('should have length of 8 from leading zero', () => {
        const a = new BigNumber('fb9604', 16)

        expect(a.toString('hex', 8)).toHaveLength(8)
      })
      ...
      it('should have length of 64 from leading 15', () => {
        ...
        expect(a.toString('hex', 2)).toHaveLength(64)
      })
      ...
      it('should have length of 64 from leading zero', () => {
        ...
        expect(a.toString('hex', 64)).toHaveLength(64)
      })
    })
  })
  ...
  describe('.fromTwos', () => {
    it("should convert from two's complement to negative number", () => {
      ...
      expect(
        new BigNumber('fffffffffffffffffffffffffffffffe', 16).fromTwos(128).toNumber()
      ).toEqual(-2)
      expect(
        new BigNumber('ffffffffffffffffffffffffffffffff' + 'fffffffffffffffffffffffffffffffe', 16)
          .fromTwos(256)
          .toNumber()
      ).toEqual(-2)
      expect(
        new BigNumber('ffffffffffffffffffffffffffffffff' + 'ffffffffffffffffffffffffffffffff', 16)
          .fromTwos(256)
          .toNumber()
      ).toEqual(-1)
      expect(
        new BigNumber('7fffffffffffffffffffffffffffffff' + 'ffffffffffffffffffffffffffffffff', 16)
          .fromTwos(256)
          .toString(10)
      ).toEqual(
        new BigNumber(
      ...
      expect(
        new BigNumber('80000000000000000000000000000000' + '00000000000000000000000000000000', 16)
          .fromTwos(256)
          .toString(10)
      ).toEqual(
        new BigNumber(
  ...
  describe('.toTwos', () => {
    it("should convert from negative number to two's complement", () => {
      ...
      expect(
        new BigNumber(
          '5789604461865809771178549250434395392663' + '4992332820282019728792003956564819967',
          10
        )
          .toTwos(256)
          .toString(16)
