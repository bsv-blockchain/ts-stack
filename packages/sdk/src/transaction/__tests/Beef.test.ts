...
describe('Beef tests', () => {
  ...
  const chainTracker = {
    ...
    isValidRootForHeight: async (root: string, height: number) => {
      const knownRoots = {
        1631619: 'a3dd0604ac7a431a90d19f04b073b00007963947163f98e38a23229c43c69b0a',
        875732: 'a19c54129ab996c72cda7721b4555b47d11b21e1fe67aa63c59843edb302b6c2',
        1651724: '0fa8e6a2a8860eaec7365217c1cf64a905dc7936342b36a86566f933187f8c62'
      }
  ...
  test('0_mergeTransaction', async () => {
...

    {
      ...
      expect(btx.rawTx).toBeUndefined(undefined)
    }
  ...
  test('4_mergeTransaction with parent txs', async () => {
    {
      ...
      expect(beefB.txs).toHaveLength(2)
...
`)
  ...
  test('6b_trimKnownTxids_removes_unreferenced_bumps', async () => {
    ...
    expect(beef.txs).toHaveLength(1)
    expect(beef.bumps).toHaveLength(1) // Bump should still be there because it's referenced
    ...
    expect(beef.txs).toHaveLength(0)
    expect(beef.bumps).toHaveLength(0)
  })
  ...
  test('6c_trimKnownTxids_updates_bump_indices', async () => {
    ...
    expect(beef.txs).toHaveLength(initialTxCount + 2)
    expect(beef.bumps).toHaveLength(initialBumpCount)
    ...
    expect(beef.txs).toHaveLength(initialTxCount)
...
const bumpIndexEncoding =
  ''
