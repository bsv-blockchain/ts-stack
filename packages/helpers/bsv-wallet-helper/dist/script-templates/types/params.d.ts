 ...
 */
export type P2PKHLockParams = P2PKHLockWithPubkeyhash | P2PKHLockWithPublicKey | P2PKHLockWithAddress | P2PKHLockWithWallet;
/**
 ...
 */
export type OrdinalLockParams = OrdinalLockWithPubkeyhash | OrdinalLockWithPublicKey | OrdinalLockWithAddress | OrdinalLockWithWallet;
/**
