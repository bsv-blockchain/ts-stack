...
- **WalletP2PKH Examples**: [src/script-templates/**tests**/p2pkh.test.ts](./src/script-templates/__tests__/p2pkh.test.ts#L146)
  - Creating and spending P2PKH transactions
  - Multiple inputs with wallet signing
  - Different signature scopes (SIGHASH_SINGLE)

- **WalletOrdP2PKH Examples**: [src/script-templates/**tests**/ordinal.test.ts](./src/script-templates/__tests__/ordinal.test.ts#L146)
