 ...
 * OTEL_CONSOLE_EXPORTERS=true explicitly enables local console diagnostics.
 * Application logging remains available in every mode.
 *
...
// No SDK, instrumentation, console bridge or shutdown hooks without an exporter.
if (useOtlp || process.env.OTEL_CONSOLE_EXPORTERS === 'true') {
